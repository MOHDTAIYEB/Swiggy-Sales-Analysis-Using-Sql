...
Fact Table: fact_swiggy_orders (Centralized metrics: Price, Ratings, and Order IDs).
...
Financial Performance: Calculated Total Revenue (formatted in Millions) and Average Order Value (AOV).
